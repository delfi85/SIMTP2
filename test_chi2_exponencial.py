...
class ChiExpWindow(QWidget):
    ...
    def agrupar_intervalos(self, datos_tabla_original):
        ...
        frecuencias_acumuladas = 0
        limite_inferior_agrupado = None
        limite_superior_agrupado = None
        ...
        for fila in datos_tabla_original:
            ...
            if frecuencia_esp < 5:
                frecuencias_acumuladas += frecuencia_esp
                if limite_inferior_agrupado is None:
                    limite_inferior_agrupado = limite_inferior
                limite_superior_agrupado = limite_superior
            else:
                if limite_inferior_agrupado is not None:
                    datos_tabla_agrupada.append(["", limite_inferior_agrupado, limite_superior_agrupado,
                                                 frecuencias_acumuladas, frecuencias_acumuladas,
                                                 ""])
                    limite_inferior_agrupado = None
                    frecuencias_acumuladas = 0
                datos_tabla_agrupada.append(fila)
